...
public class CoordonneesTest {
    ...
    public void testCalculDistance() {
        Coordonnees coord1 = new Coordonnees(15.5,15.2,0);
        Coordonnees coord2 = new Coordonnees(15.5,15.2,0);
        assertEquals("",0.0,coord1.distanceTo(coord2));

        coord1 = new Coordonnees(44.36204454087336, 2.565200426862144,0);
        coord2 = new Coordonnees(44.36149999669016, 2.5698567263639505,0);
